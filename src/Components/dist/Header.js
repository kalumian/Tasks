    ...
    return (react_1["default"].createElement("header", { className: "header" },
        react_1["default"].createElement("div", { className: "container" },
            react_1["default"].createElement("div", { className: "logo" },
                react_1["default"].createElement(react_router_dom_1.Link, { to: "contant" }, "TASKS")),
            react_1["default"].createElement("nav", { className: "nav" },
                react_1["default"].createElement("ul", null,
                    ...
                    react_1["default"].createElement(ItemLink, { link: links_json_1["default"].links.Contant, title: "\u0639\u0646 \u0627\u0644\u0645\u0648\u0642\u0639" }),
